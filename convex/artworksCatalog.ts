 ...
 *   (a) name the LOCATION (not the pose) — "on the hilltop", "by the
 *       village", "at the base of the cypress". Pose is deliberately left
 *       open so the runtime quiz signal (`activity`) can drive it via
 *       ARTWORK_ACTIVITY_TONE in seedream.ts. NEVER bake "standing",
 *       "sitting", "lying", "trotting", etc. back into a placement.
